...
ActiveRecord::Schema[7.0].define(version: 2023_07_04_172353) do
  ...
  create_table "my_groups", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["author_id"], name: "index_my_groups_on_author_id"
  end
  ...
  add_foreign_key "expense_groups", "my_groups", column: "group_id"
